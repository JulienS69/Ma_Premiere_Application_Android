...
public class RdvPraticienActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvRdvPraticiens = (ListView)findViewById(R.id.listRdvPraticien);
    ...
    private void gestionClick2() {
        ((ImageButton) this.findViewById(R.id.btnRetourdeRdvPraticiens)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Toast.makeText(RdvPraticienActivity.this, "Retour à l'accueil", Toast.LENGTH_SHORT).show();
                Log.d("message", "Retour à l'accueil");
                Intent i = new Intent(RdvPraticienActivity.this, AccueilActivity.class);
                startActivity(i);
            }
        });
